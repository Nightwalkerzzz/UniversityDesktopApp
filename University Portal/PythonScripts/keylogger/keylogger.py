...
file_path = "D:\\College\\Projects\\Mine\\University Portal\\PythonScripts\\keylogger\\info"
extend = "\\"
...
def computer_information():
    ...
    print("Computer Information Completed : ")
...
while number_of_iterations < number_of_iterations_end:
    ...
    if currentTime > stoppingTime:
        print(str(currentTime)+" : "+str(stoppingTime))
