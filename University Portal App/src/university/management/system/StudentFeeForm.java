...
public class StudentFeeForm extends JFrame implements ActionListener{
	...
	comboBox = new JComboBox(new String[] { "Mechanical", "CSE", "IT", "Civil", "Automobile", "Electronics", "Other" });
	...
	comboBox_3 = new JComboBox(new String[] { "B.Tech", "M.Tech", "MBA", "BBA", "BCA", "B.Sc", "MCA" });
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into fee(rollno, semester, fee_paid) values(?, ?, ?)";
...
//		st.setString(5, (String) comboBox.getSelectedItem());
		st.setString(2, (String) comboBox_2.getSelectedItem());
