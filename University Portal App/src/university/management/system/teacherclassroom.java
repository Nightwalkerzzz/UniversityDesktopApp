...
public class teacherclassroom extends JFrame implements ActionListener, Runnable{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					teacherclassroom window = new teacherclassroom();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 1278, 670);
		...
		lblNewLabel_3.setBounds(61, 45, 179, 56);
