...
class AddTeacher implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
            	if(a.isEmpty()||bb.isEmpty()||c.isEmpty()||d.isEmpty()||ff.isEmpty()||g.isEmpty()) {
                ...
                q = "insert into login_t values('"+l+"','"+l+"')";
                cc.s.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"Username : "+l+"\n Password : "+l);
                f.setVisible(false);
            	}
            }catch(Exception ee){
